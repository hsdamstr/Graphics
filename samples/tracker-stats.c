...
int main(int argc, char *argv[])
{
	...
	float *x = (float*)malloc(sizeof(float)*numRecords);
	float *y = (float*)malloc(sizeof(float)*numRecords);
	float *z = (float*)malloc(sizeof(float)*numRecords);
	...
	float *q1 = (float*)malloc(sizeof(float)*numRecords);
	float *q2 = (float*)malloc(sizeof(float)*numRecords);
	float *q3 = (float*)malloc(sizeof(float)*numRecords);
	float *q4 = (float*)malloc(sizeof(float)*numRecords);
