...
void get_model_matrix(float result[16])
{
	...
	mat4f_copy(result, rotateAnimate);
}
...
int main(int argc, char** argv)
{
	...
	// Scale/translate model so it is centered at the origin.
