...
MagickWand library. For a list of supported file formats, see
 ...
 * versions of ImageMagick. Ideally, we'd retrieve the values via
 * Cmake that are correct for this imagemagick installation.
 * MagickWand-config should also print the correct values these should
 * be set to. It doesn't appear that this information is exposed in
 * the default FindImageMagick.cmake file. */
