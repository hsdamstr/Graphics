...
extern inline void mat3f_mult_mat3f_new(float  result[9], const float  matA[ 9], const float  matB[ 9]);
extern inline void mat3d_mult_mat3d_new(double result[9], const double matA[ 9], const double matB[ 9]);
extern inline void mat4f_mult_mat4f_new(float  result[16], const float  matA[16], const float  matB[16]);
extern inline void mat4d_mult_mat4d_new(double result[16], const double matA[16], const double matB[16]);
